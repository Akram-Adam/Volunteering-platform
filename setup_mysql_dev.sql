...
-- Create the user
CREATE USER IF NOT EXISTS 'VolunConnect_admin_app_dev'@'localhost' IDENTIFIED BY 'Volunteer_dev';
...
GRANT ALL PRIVILEGES ON VolunConnect_dev_dp.* TO 'VolunConnect_admin_app_dev'@'localhost';
